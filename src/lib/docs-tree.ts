...
export const DOC_NAV: DocGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'customization/generators',         label: 'Customizing generators', icon: 'Bolt',      badge: '18', tooltip: '18 Artisan generators (martis:resource, martis:action, …)' },
      { slug: 'customization/i18n',               label: 'Internationalization',   icon: 'Translate', badge: '3',  tooltip: '3 bundled locales: en, pt_PT, pt_BR' },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'auth/invitations',    label: 'Invitations',    icon: 'Lock' },
