...
description: "Reuse any Martis Field — `Slug`, `Text`, `BelongsTo`, … — inside a custom Tool and get the exact same behaviour it has in a Resource form: slugify, generate-from-source, `dependsOn`, validation display, i18n, and theming, from one shared code path."
