---
title: "Theming"
description: "Martis uses **CSS custom properties** (variables) for all styling. A theme is a CSS file that overrides these variables. Themes apply globally and support both **dark** and **light** modes."
sourcePath: "martis-package/docs/theming.md"
---
