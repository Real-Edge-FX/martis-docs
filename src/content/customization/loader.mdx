---
title: "Loader"
description: "The Martis Loader is a built-in loading indicator that appears automatically during data fetches, page transitions, and async operations. It is fully configurable and replaceable without forking the package."
sourcePath: "martis-package/docs/loader.md"
---
...
interface MartisLoaderProps {
   ...
   * `config.loader`. The wrapper passes the active resource's
   * `Resource::loaderConfig()` here automatically.
   */
