...
description: "Martis ships a generator for AI coding agents (Claude Code, Codex, Cursor, Gemini, Copilot) plus an optional MCP server that exposes the package documentation over the Model Context Protocol."
