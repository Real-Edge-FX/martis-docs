...
description: "The override system is a core Martis differential. Everything can be customized without forking — React components, layouts, and server-side behaviors."
