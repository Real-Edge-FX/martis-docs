---
title: "Quick Start"
description: "Build your first Martis resource in five minutes."
sourcePath: "martis-package/docs/quick-start.md"
---
...
- [Filters](/docs/core/filters) and [lenses](/docs/core/lenses) — sticky views and alternative queries.
- [Metrics & dashboards](/docs/core/metrics) — value, trend, partition, progress, activity feed cards.
