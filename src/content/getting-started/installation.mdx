...
- **A custom `MARTIS_GUARD`** now signs in the panel's user everywhere, policies and gates included: see [Upgrading → A custom Martis guard](https://github.com/Real-Edge-FX/martis-package/blob/main/docs/upgrading.md#a-custom-martis-guard) before you upgrade an app that sets one.
