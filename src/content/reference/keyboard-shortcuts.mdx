...
description: "Martis ships a tiny in-house registry for keyboard shortcuts. Every combo the admin shell, custom Tools, or consumer plugins want to bind goes through one API — so the help overlay (`Shift+?`) always lists the live set, and conflict detection has a single point of truth."
sourcePath: "martis-package/docs/keyboard-shortcuts.md"
---
