...
description: "Martis shows in-app notifications in a topbar bell, built on Laravel's standard notifications table since v0.8 (before it, only toasts). Anything you already deliver via the database channel surfaces in the bell with zero glue."
sourcePath: "martis-package/docs/notifications.md"
---
