...
[Fields → Tooltips](/docs/core/fields#tooltips) for the full rationale and the
...
[metrics.md](/docs/core/metrics#activity-feed-metric).
...
[metrics.md](/docs/core/metrics#endpoint-table-metric).
