---
title: "Highlights"
description: "A tour of the surfaces Martis ships beyond the bare-essential admin-panel contract — features that exist as first-class APIs in the package, with their own configuration, generators, or escape hatches. Each entry below links into the dedicated reference for the full surface."
