...
> **Asset requirement.** Crop your image to remove transparent padding before deployment. The browser scales the *whole canvas*; padding makes the visible artwork appear smaller.
