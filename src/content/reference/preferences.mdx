...
description: "| Preference | Values | Default | |------------|--------|---------| | theme | dark · light · system | dark | | accent | martis · blue · teal · violet · amber · custom | martis | | brandColor | #RGB · #RGBA · #RRGGBB · #RRGGBBAA · null | null (off by default — opt-in via allowBran"
...
- [theming.md](/docs/customization/theming) — the 94-token design system that preferences drive.
