...
description: "Martis persists per-user UI preferences (theme, accent, density, locale, reduced-motion) so settings travel across devices and sessions. Exposed through a compact overlay in the topbar."
...
- [differentials.md](/docs/reference/differentials) — full differentials list.
