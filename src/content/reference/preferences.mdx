...
description: "| Preference | Values | Default | |------------|--------|---------| | `theme` | `dark` · `light` · `system` | `dark` | | `accent` | `martis` · `blue` · `teal` · `violet` · `amber` · `custom` | `martis` | | `brandColor` | `#RGB` · `#RGBA` · `#RRGGBB` · `#RRGGBBAA` · `null` | `null"
