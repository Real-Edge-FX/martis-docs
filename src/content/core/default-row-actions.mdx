...
description: "Every Martis resource index ships with built-in View / Edit / Delete row actions out of the box, with three layers of control: global config, per-resource override, and authorization-aware disable."
