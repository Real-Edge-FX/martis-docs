---
title: "Repeater"
description: "Repeatable row widget backed by JSON, a child table (HasMany) or a single polymorphic child table. Ships **five Martis differentials** — drag-and-drop reorder, collapse, cardinality limits, dynamic row headers, row templates, duplicate, bulk paste, and a polymorphic storage mode"
