...
description: "Martis supports three layout mechanisms for organising fields on forms and detail pages: **Panels**, **Tabs**, and **Sections**."
sourcePath: "martis-package/docs/panels-and-tabs.md"
---
