---
title: "Sticky Views"
description: "Sticky views keep a resource table as the user left it when they open a record and come back: same filter, same sort, same page, same search query. No need to redo the work."
