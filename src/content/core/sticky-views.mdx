---
title: "Sticky Views"
description: "A user applies a filter, opens a record, and clicks back. The table is **exactly** as they left it. Same filter, same sort, same page, same search query. No need to redo the work."
