...
> **Version note.** Martis v2.0 and later read `options()` as `[value => label]`, Nova's order; Martis v1.x read `[label => value]`. On v1.x, flip the arrays in the examples below, or upgrade: see [Upgrading](https://github.com/Real-Edge-FX/martis-package/blob/main/docs/upgrading.md).
