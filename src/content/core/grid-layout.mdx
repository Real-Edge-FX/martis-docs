---
title: "Grid Layout — Section & Field Span"
description: "Martis supports a flexible, grid-based form layout system that lets you organise fields into responsive multi-column rows inside `create` and `update` forms."
sourcePath: "martis-package/docs/grid-layout.md"
---
