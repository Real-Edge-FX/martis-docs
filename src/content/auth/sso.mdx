...
description: "This document is the long-form reference. For a 30-second TL;DR see the Quick start below. For step-by-step Azure setup, jump to Azure AD — full step-by-step."
