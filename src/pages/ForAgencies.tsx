...
export default function ForAgencies() {
  return <SiteShell><main id="main-content">
    ...
    <section className="section compact-cta"><div className="site-container"><div><p className="eyebrow"><span /> Try the baseline</p><h2>Start with one project.<br /><em>Reuse what proves itself.</em></h2></div><InstallCommand /></div></section>
  </main></SiteShell>
}
